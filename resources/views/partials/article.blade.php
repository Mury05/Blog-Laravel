 ...
 <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
    ...
    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 "><a href="#">{{ $article['title'] }}</a></h2>
    <p class="mb-5 font-light text-gray-500 ">{{ $article->user->name }}</p>
    <div class="flex justify-between items-center">
        <a href="/article/{{ $article->id }}" class="inline-flex items-center font-medium text-green-600 hover:underline">
            Read more
